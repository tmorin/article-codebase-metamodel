...
It is an action (i.e. the query) that request for information about to the state of an application. As a response, a result is provided to the producer.
...
This setup ensures that the read models are both accessible externally and reliably maintained, aligning with the system’s data integrity and accessibility requirements.
