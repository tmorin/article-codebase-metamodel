...
[source,java]
----
include::../example/todoapp-java/todoapp-scenarios/src/main/java/todoapp/core/CreateTodoListScenario.java[]
----
...
[source,java]
----
include::../example/todoapp-java/todoapp-scenarios/src/main/java/todoapp/core/ListTodoListsScenario.java[]
----
...
[source,java]
----
include::../example/todoapp-java/todoapp-adapter-mem/src/main/java/todoapp/adapter/mem/InMemoryTodoListRepository.java[]
----
